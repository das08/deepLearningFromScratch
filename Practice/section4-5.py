...
import numpy as np
from assets.common.functions import *
...
class TwoLayerNet:
    ...
    def get_gradient_faster(self, x, t):
        W1, W2 = self.params['W1'], self.params['W2']
        b1, b2 = self.params['b1'], self.params['b2']
        grads = {}
...
for i in range(iters_num):
    ...
    # clac grad
    grad = network.get_gradient_faster(x_batch, t_batch)
    ...
    if i % iter_per_epoch == 0:
        ...
        print(f"train, test acc: {train_acc}, {test_acc}")
